      ...
      <b-navbar toggleable="lg" type="dark" variant="info" fixed="top">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <b-nav-item to="/synchronisation">Synchronization</b-nav-item>

          </b-navbar-nav>

          <!-- Right aligned nav items -->
          <b-navbar-nav class="ml-auto"  v-if="webId != null">
            <b-nav-form>
...
<div v-else>
  <b-jumbotron header="Contacts" lead="Contacts store your Contacts on your Solid POD in the rootFolder/contacts/ folder.">
    <p>For more information visit <a href="https://github.com/scenaristeur/contacts/blob/main/README.md" target="_blank">github repo</a></p>
